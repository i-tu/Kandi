...
Poikkeuksena tästä on tilanne, jossa noodi kytkeytyy itseensä.
Kerrostetuksen graafin tulee olla kompakti.
...
Vaikka sen lyhyyttä ei ole todistettu, on se käytännössä nopea eikä vaadi montaa iterointia.

Ensin valitaan alkuperänen noodi ja asetetaan se ensimmäiseen kerrokseen.
Jokaiseen siihen kytkeytyvään noodiin 

Tätä prosessia jatketaan kunnes jokainen noodi on asetettu johonkin kerrokseen.
