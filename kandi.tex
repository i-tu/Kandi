...
Työssä suunniteltiin 

		\subsection{Suunniteluohjelmistot}
...
Malli, jonka mukaan logiikka tallennetaan täytyy olla yhdenmukainen, jotta suunnittelutyössä voidaan tehdä tehokasta yhteistyötä.
Suunnitteluohjelmsitot ovat vähintään yhteensopivia itsensä kanssa. työpaikalla jaettujen yhtenäisten suunnittelun apuvälineiden avulla.
...
Logiikkaa kuvataan usein XML-pohjaisilla kuvauksilla.

Tällainen on esimerkiksi PLCOpen, joka määrittelee XML-kuvauksen IEC 61131-3 mukaisista ohjelmointikielistä.
...
Monet ohjelmistot, kuten CoDeSys, pystyvät tuottamaan PLCopen-muotoista tietoa.

PLCopen -standardin mukainen XML-esitys voi sisältää toimilohkon toiminnallisuuden kannalta välttämättömien asioiden lisäksi
toimilohkon sijainnin, koon ja jopa lankojen reititykset.
PLCopen -standardin mukainen esitys voidaan tällöin laatia stein, että se on tuotettavan kaavion kannalta täysin yksiselitteinen.
...
jottei syklien poistovaiheessa kaavion järjestys muutu.
...
Kerrostetuksen graafin tulee olla olla kompakti. Tämä tarkoittaa että sen leveys ja pituus ovat pieniä ja kerrosten välinen etäisyys on vakio
