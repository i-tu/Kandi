...
Se on tietomalli, joka kuvaa tehtaan toimintaa, sen prosessia ja laajuudestaan riippuen myös sen organisaatiota, ihmisiä ja toimintaa.
...
Ohjelmiston toteuttamiseen ei pitäisi liittyä enää suunnittelutyötä \textemdash toisin sanoen toiminnallisen kuvauksen määrittelyjen täytyy olla riittävän tarkkoja, jotta niitten mukaan tehdyssä ohjelmassa ei ole sen toimintaan vaikuttavia tulkinnanvaraisuuksia.
...
Esteettiset ominaisuudet ovat usein ristiriidassa keskenään \textemdash jotta voitaisiin esimerkiksi välttää langan piirto solmun läpi, joudutaan siihen tekemään mutkia.
...
\begin{figure}[ht]
	...
	\caption{Yksinkertaisen verkon asettelu. Toimilohkoissa on 1\textendash2 lähtöä ja syklejä ei ole.}
\end{figure}

Kuvassa kolme nähdään paljon vaihtelua sisältävä verkko.
Toimilohkoissa on lähtöjä välillä 0\textendash4 ja takaisinkytkentöjä on paljon.
...
\begin{figure}[ht]
	...
	\caption{Vaihtelua sisältävän verkon asettelu. Toimilohkoissa on 0\textendash4 lähtöä.}
\end{figure}
