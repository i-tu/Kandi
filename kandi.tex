...
Suunniteltu logiikka tallennetaan jaettuun suunnittelumalliin.


Formaaliksi kuvaukseksi on esitetty XML-pohjaisia kuvauskieliä. Tällainen on esimerkiksi OpenPLC, joka on XML-kuvaus
IEC 61131-3 mukaisesta FBD-kaaviosta.

Tämän työn tavoitteena on muuntaa
...
Suoritusjärjestysvaatimus asettaa myös toteutukselle rajoituksia. Jos niitä ei oteta
