	...
	\univdegree{BSc}
	\author{Ian Tuomi}{}
	\thesistitle{}{Kaavioiden esteettinen generointi tehdassuunnittelun apuvälineenä}

	\place{Espoo}
	\date{6.12.2012}
	\supervisor{DI Mika Str\"{o}mman}{DI Pekka Forsman}
...
Tämä lähestymistapa tuottaa huomattavan suuria yksittäisiä kerroksia.

Kun kerrostuksesta halutaan mahdollisimman kapea, kannattaa käyttää multiprosessoriajastusongelman ratkaisemiseen kehitettyä Coffmann-Graham -algoritmia \cite{RefWorks:59}.
...
Tuloksena saadusta kerrostuksesta muodostetaan uusi virityspuu, ja menetelmää jatketaan edelleen kunnes kaikki virityspuun leikkausarvoista ovat positiivisia. \cite{RefWorks:28}
