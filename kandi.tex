...
Työssä käytetään Gansner ym. esittäämää "Network Simplex"-algoritmia, joka
\emph{TO DO: SELITÄ TÄMÄ}
...
Graadin esteetiikka erittelee ominaisuudet mitä graafiin halutaan mahdollisimman paljon, jota se olisi mahdollismman luettava.
