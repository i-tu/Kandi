...
Moni suunnittelija varmasti toivoo, että voisi keskittyä varsinaiseen suunnittelutyöhön ilman, että tarvitsisi uhrata aikaa työtavoista- ja käytännöistä johtuvaan ylimääräiseen työhön.
Automaattinen asettelu on askel kohti tällaisia tehdassuunnittelun käytäntöjä.
